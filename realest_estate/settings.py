...
SECRET_KEY = 'django-insecure-!)7x4@!d0b2a30zeyh*26vku4nkn0lk%=#*4_0@^10@b8=ncxb'
...
EMAIL_HOST_PASSWORD = 'ahatxklijffnimzk'
EMAIL_USE_TLS = True
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES':[
        #cant access a view if not authenticated
...
#increse possible size of files uploaded
